package com.example.springboot._common.exception.handler;
...
import com.example.springboot._common.exception.utils.ExceptionUtils;
...
import static com.example.springboot._common.exception.utils.ExceptionUtils.handleExceptionInternal;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> handleApiException(ApiException e) {
        ...
        return handleExceptionInternal(e.getCode(), e.getCode().getMessage());
    }
    ...
    public ResponseEntity<Object> handleNullPointerException(NullPointerException e) {
        ...
        return handleExceptionInternal(ResponseCode.INTERNAL_SERVER_ERROR, "비어있는 값이 들어올 수 없습니다.");
    }
